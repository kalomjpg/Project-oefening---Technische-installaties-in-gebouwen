...
Zie Figuur \ref{fig:dimensioneringkanalen} voor de resultaten. 

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{figuren/kanaaldimenties.png}
    \caption{dimensionering kanalen}
    \label{fig:dimensioneringkanalen}
\end{figure}
\FloatBarrier
...
\end{equation}
met:
Phi het werkelijk afgegeven vermogen van de radiator

C de specifieke warmtecapaciteit van water

In de noemer het verschil van de ontwerpvertrektemperatuur en de ontwerpretourtemperatuur.

Bij een gemiddelde watertemperatuur van 40°C vindt men in tabel A.1 uit het WTCB Rapport 14 dat de waarde van c gelijk is aan 4179 J/kgK. 
