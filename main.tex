...
Om het hydraulisch evenwicht in de praktijk te realiseren, wordt het berekende extra drukverschil over de bijkring weggewerkt door middel van een specifieke voorinstelling op de thermostatische radiatorkraan [1]. Voor bijkring A bedraagt dit in te regelen drukverschil ($\Delta p_{inregel}$) $361,39 \text{ Pa}$, oftewel afgerond $0,36 \text{ kPa}$. 

Het benodigde massadebiet ($q_{m,rad}$) voor het verwarmingslichaam in deze kring (de kleine slaapkamer) is eerder vastgesteld op $53,67 \text{ kg/h}$, wat in de praktijk gelijkgesteld mag worden aan een volumedebiet van circa $54 \text{ l/h}$. 

Aan de hand van de karakteristieke nomogrammen voor radiatorkranen (conform de ontwerprichtlijnen uit het WTCB-Rapport 14) kan de correcte kraanstand worden bepaald. Het snijpunt van het ontwerpdebiet ($54 \text{ l/h}$) en het te creëren extra drukverlies ($0,36 \text{ kPa}$) resulteert in het voorliggende ontwerp in \textbf{stand 5} (zie figuur\ref{fig:drukverliesthermostaatkraan}). Deze voorinstelling garandeert dat de betreffende bijkring de exacte ontwerpweerstand levert, waardoor het waterdebiet correct verdeeld wordt en oververhitting van deze kortere kring wordt voorkomen.
